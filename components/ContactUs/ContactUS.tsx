...
const RECIPIENT_EMAIL = "info@zahabusolutions.com";
...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F7F7F7]">
      ...
      <div className="relative pt-32 pb-24 section-padding overflow-hidden min-h-70">
        {/* Background image */}
        <Image
          src="/contact.png"
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div>
                  <p className="text-muted text-xs uppercase tracking-wider font-semibold mb-0.5">
                    Phone
                  </p>
      ...
      <div className="relative w-full">
        <iframe
          ...
          style={{
            border: 0,
            display: "block",
            filter: "grayscale(10%) contrast(1.02) brightness(0.97)",
          }}
          allowFullScreen
          loading="lazy"
